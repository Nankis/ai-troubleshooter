...
| Task | 状态 | 说明 |
| --- | --- | --- |
| T1 | done | 建立 Program，明确只做 Qwen/GPT 和 Web Vision 验收。 |
| T2 | done | 实现 Python LLM/Vision 配置读取和 OpenAI-compatible Vision provider。 |
| T3 | done | 补充单测，覆盖 Qwen/GPT profile、health-food config、Vision body。 |
