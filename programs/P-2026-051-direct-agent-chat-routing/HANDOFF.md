...
- 本地 Web + MySQL 验证已通过，证据 case：`case_20260525_000063`、`case_20260525_000064`、`case_20260525_000065`。
- `case_20260525_000064` 验证“现在是用什么模型”由 `llm_decision_agent / local_agent / codex` 回答，且 `tool_invocation=0`。
- `case_20260525_000065` 验证最终话术：明确本次真实决策 Agent 是 `codex/codex`，`local_rules/rules-v1` 只是平台主 LLM profile。
...
- Web screenshot: `programs/P-2026-051-direct-agent-chat-routing/artifacts/web-runtime-status-direct-agent-case-65.png`.
